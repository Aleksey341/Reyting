-- Sample data: ФИО глав муниципальных образований Липецкой области
-- Используется для тестирования вкладки "Рейтинг"

-- Примечание: Замените значения на реальные ФИО глав МО в вашей системе

BEGIN;

-- Добавляем ФИО глав МО (примеры из вашего примера)
...
-- Проверка: Вывести все МО с заполненными ФИО
